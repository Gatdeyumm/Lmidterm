                    ...
                    <div class="flex justify-between h-16">
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ml-6">
                            ...
                            <div class="relative inline-flex items-center ml-3">
                                ...
                                <button @click="darkTheme = !darkTheme" class="relative m-5 focus:outline-none">
  <div class="flex items-center w-12 h-6 p-1 transition-transform duration-300 ease-in-out bg-gray-300 rounded-full dark:bg-gray-800 hover:bg-gray-400 dark:hover:bg-gray-700">
    <div :class="[darkTheme ? 'bg-white' : 'bg-yellow-500', 'w-6 h-6 rounded-full shadow-md transform']"></div>
    <i :class="darkTheme ? 'fas fa-moon text-white' : 'fas fa-sun text-yellow-500'"></i>
  </div>
</button>
